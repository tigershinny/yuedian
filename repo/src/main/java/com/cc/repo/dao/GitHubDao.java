...
/** 
 * DAO for table "GIT_HUB".
*/
public class GitHubDao extends AbstractDao<GitHub, Long> {

    public static final String TABLENAME = "GIT_HUB";

    /**
     * Properties of entity GitHub.<br/>
     * Can be used for QueryBuilder and for referencing column names.
    */
    public static class Properties {
        public final static Property Login = new Property(0, String.class, "login", false, "LOGIN");
        ...
        public final static Property SiteAdmin = new Property(16, Boolean.class, "siteAdmin", false, "SITE_ADMIN");
        public final static Property Name = new Property(17, String.class, "name", false, "NAME");
        public final static Property Company = new Property(18, String.class, "company", false, "COMPANY");
        public final static Property Blog = new Property(19, String.class, "blog", false, "BLOG");
        ...
        public final static Property Hireable = new Property(22, Boolean.class, "hireable", false, "HIREABLE");
        public final static Property Bio = new Property(23, String.class, "bio", false, "BIO");
        public final static Property PublicRepos = new Property(24, Integer.class, "publicRepos", false, "PUBLIC_REPOS");
        public final static Property PublicGists = new Property(25, Integer.class, "publicGists", false, "PUBLIC_GISTS");
        public final static Property Followers = new Property(26, Integer.class, "followers", false, "FOLLOWERS");
        public final static Property Following = new Property(27, Integer.class, "following", false, "FOLLOWING");
        public final static Property CreatedAt = new Property(28, String.class, "createdAt", false, "CREATED_AT");
        public final static Property UpdatedAt = new Property(29, String.class, "updatedAt", false, "UPDATED_AT");
    };


    public GitHubDao(DaoConfig config) {
        super(config);
    }
    
    public GitHubDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"GIT_HUB\" (" + //
                "\"LOGIN\" TEXT NOT NULL ," + // 0: login
                ...
                "\"TYPE\" TEXT," + // 15: type
                "\"SITE_ADMIN\" INTEGER," + // 16: siteAdmin
                "\"NAME\" TEXT," + // 17: name
                "\"COMPANY\" TEXT," + // 18: company
                "\"BLOG\" TEXT," + // 19: blog
                "\"LOCATION\" TEXT," + // 20: location
                "\"EMAIL\" TEXT," + // 21: email
                "\"HIREABLE\" INTEGER," + // 22: hireable
                "\"BIO\" TEXT," + // 23: bio
                "\"PUBLIC_REPOS\" INTEGER," + // 24: publicRepos
                "\"PUBLIC_GISTS\" INTEGER," + // 25: publicGists
                "\"FOLLOWERS\" INTEGER," + // 26: followers
                "\"FOLLOWING\" INTEGER," + // 27: following
                "\"CREATED_AT\" TEXT," + // 28: createdAt
                "\"UPDATED_AT\" TEXT);"); // 29: updatedAt
    }

    /** Drops the underlying database table. */
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"GIT_HUB\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, GitHub entity) {
        stmt.clearBindings();
        ...
        Boolean siteAdmin = entity.getSiteAdmin();
        if (siteAdmin != null) {
            stmt.bindLong(17, siteAdmin ? 1L: 0L);
        }
        ...
        if (company != null) {
            stmt.bindString(19, company);
        }
 
        String blog = entity.getBlog();
        if (blog != null) {
            stmt.bindString(20, blog);
        }
        ...
        if (hireable != null) {
            stmt.bindLong(23, hireable ? 1L: 0L);
        }
 
        String bio = entity.getBio();
        if (bio != null) {
            stmt.bindString(24, bio);
        }
 
        Integer publicRepos = entity.getPublicRepos();
        if (publicRepos != null) {
            stmt.bindLong(25, publicRepos);
        }
 
        Integer publicGists = entity.getPublicGists();
        if (publicGists != null) {
            stmt.bindLong(26, publicGists);
        }
 
        Integer followers = entity.getFollowers();
        if (followers != null) {
            stmt.bindLong(27, followers);
        }
 
        Integer following = entity.getFollowing();
        if (following != null) {
            stmt.bindLong(28, following);
        }
 
        String createdAt = entity.getCreatedAt();
        if (createdAt != null) {
            stmt.bindString(29, createdAt);
        }
 
        String updatedAt = entity.getUpdatedAt();
        if (updatedAt != null) {
            stmt.bindString(30, updatedAt);
        }
    }
    ...
    /** @inheritdoc */
    @Override
    public GitHub readEntity(Cursor cursor, int offset) {
        GitHub entity = new GitHub( //
            ...
            cursor.isNull(offset + 16) ? null : cursor.getShort(offset + 16) != 0, // siteAdmin
            cursor.isNull(offset + 17) ? null : cursor.getString(offset + 17), // name
            cursor.isNull(offset + 18) ? null : cursor.getString(offset + 18), // company
            cursor.isNull(offset + 19) ? null : cursor.getString(offset + 19), // blog
            ...
            cursor.isNull(offset + 22) ? null : cursor.getShort(offset + 22) != 0, // hireable
            cursor.isNull(offset + 23) ? null : cursor.getString(offset + 23), // bio
            cursor.isNull(offset + 24) ? null : cursor.getInt(offset + 24), // publicRepos
            cursor.isNull(offset + 25) ? null : cursor.getInt(offset + 25), // publicGists
            cursor.isNull(offset + 26) ? null : cursor.getInt(offset + 26), // followers
            cursor.isNull(offset + 27) ? null : cursor.getInt(offset + 27), // following
            cursor.isNull(offset + 28) ? null : cursor.getString(offset + 28), // createdAt
            cursor.isNull(offset + 29) ? null : cursor.getString(offset + 29) // updatedAt
        );
        return entity;
    }
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, GitHub entity, int offset) {
        ...
        entity.setSiteAdmin(cursor.isNull(offset + 16) ? null : cursor.getShort(offset + 16) != 0);
        entity.setName(cursor.isNull(offset + 17) ? null : cursor.getString(offset + 17));
        entity.setCompany(cursor.isNull(offset + 18) ? null : cursor.getString(offset + 18));
        entity.setBlog(cursor.isNull(offset + 19) ? null : cursor.getString(offset + 19));
        ...
        entity.setHireable(cursor.isNull(offset + 22) ? null : cursor.getShort(offset + 22) != 0);
        entity.setBio(cursor.isNull(offset + 23) ? null : cursor.getString(offset + 23));
        entity.setPublicRepos(cursor.isNull(offset + 24) ? null : cursor.getInt(offset + 24));
        entity.setPublicGists(cursor.isNull(offset + 25) ? null : cursor.getInt(offset + 25));
        entity.setFollowers(cursor.isNull(offset + 26) ? null : cursor.getInt(offset + 26));
        entity.setFollowing(cursor.isNull(offset + 27) ? null : cursor.getInt(offset + 27));
        entity.setCreatedAt(cursor.isNull(offset + 28) ? null : cursor.getString(offset + 28));
        entity.setUpdatedAt(cursor.isNull(offset + 29) ? null : cursor.getString(offset + 29));
     }
    
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(GitHub entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(GitHub entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
